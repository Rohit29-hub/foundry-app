...
<head><base href="../../">
    <title>
        Production Dashboard - Oriental Foundry Demo
    </title>
    <meta charset="utf-8"/>
    <meta content="follow, index" name="robots"/>
    <meta content="width=device-width, initial-scale=1, shrink-to-fit=no" name="viewport"/>
    <meta content="Production Dashboard shows jobs at various stations of the production process" name="description"/>
...
<div class="flex grow flex-col [[data-sticky-header=on]_&amp;]:pt-[--tw-header-height-default]">
    ...
    {{--                    <div class="dropdown" data-dropdown="true" data-dropdown-offset="115px, 10px" data-dropdown-placement="bottom-end" data-dropdown-trigger="click|lg:click">--}}
    ...
    {{--                        </div>--}}
    {{--                    </div>--}}
    {{--                    <div class="dropdown" data-dropdown="true" data-dropdown-offset="75px, 10px" data-dropdown-placement="bottom-end" data-dropdown-trigger="click|lg:click">--}}
    {{--                        <button class="dropdown-toggle btn btn-icon btn-icon-lg size-9 rounded-full hover:bg-gray-200 dropdown-open:bg-gray-200 text-gray-600">--}}
        ...
        <div class="container-fixed flex flex-wrap justify-between items-center gap-2">
          ...
          <span class="menu-title text-nowrap text-sm text-gray-800 menu-item-active:text-gray-900 menu-item-active:font-medium menu-item-here:text-gray-900 menu-item-here:font-medium menu-item-show:text-gray-900 menu-link-hover:text-gray-900">
           Place Order
                        ...
                        <div class="menu-item border-b border-b-transparent menu-item-active:border-b-gray-900 menu-item-here:border-b-gray-900" data-menu-item-placement="bottom-start" data-menu-item-toggle="dropdown" data-menu-item-trigger="click|lg:hover">
                        
                            <div class="menu-link gap-1.5 pb-2 lg:pb-4" tabindex="0">
          <a href="/" class="menu-title text-nowrap text-sm text-gray-800 menu-item-active:text-gray-900 menu-item-active:font-medium menu-item-here:text-gray-900 menu-item-here:font-medium menu-item-show:text-gray-900 menu-link-hover:text-gray-900">
           Production Flow
          </a>
{{--                                <span class="menu-arrow">--}}
...
{{--                                </div>--}}
{{--                                <div class="menu-item">--}}
{{--                                    <a class="menu-link" href="/jobdetail/srb572" tabindex="0">--}}
{{--            <span class="menu-title">--}}
{{--             Job Details--}}
{{--            </span>--}}
{{--                                    </a>--}}
...
{{--                            </div>--}}
                        ...
                        <div class="menu-item border-b-2 border-b-transparent menu-item-active:border-b-gray-900 menu-item-here:border-b-gray-900">
                            <a class="menu-link gap-2.5 pb-2 lg:pb-4" href="/inventory" tabindex="0">
          <span class="menu-title text-nowrap text-sm text-gray-800 menu-item-active:text-gray-900 menu-item-active:font-medium menu-item-here:text-gray-900 menu-item-here:font-medium menu-item-show:text-gray-900 menu-link-hover:text-gray-900">
           Inventory Management
                        ...
                        <div class="menu-item border-b-2 border-b-transparent menu-item-active:border-b-gray-900 menu-item-here:border-b-gray-900">
                            <a class="menu-link gap-2.5 pb-2 lg:pb-4" href="/warehouse" tabindex="0">
          <span class="menu-title text-nowrap text-sm text-gray-800 menu-item-active:text-gray-900 menu-item-active:font-medium menu-item-here:text-gray-900 menu-item-here:font-medium menu-item-show:text-gray-900 menu-link-hover:text-gray-900">
           Warehouse
          </span>
                            </a>
